                              ...
                              <table class="table table-stripped table-hover datatable">
                                 <thead class="thead-light">
                                    <tr>
                                       <th>Invoice ID</th>
                                       <th>Invoice Date</th>
                                       <th>Course Particulars</th>
                                       <th>Student Name</th>
                                       <th>Student State</th>
                                       <th>Teacher Name</th>
                                       <th>Course Gross total</th>
                                       <th>Status</th>
                                       <th>Teacher State</th>
                                 ...
                                 <?php foreach($txns->body as $value){  ?>
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $value->student_state ?></td>
                                       <td><?php echo $value->teacher_name ?></td>
                                       <td class="text-primary"><?php echo $value->c_gross_total ?> INR</td>
                                       <td><?php if($value->status == 1){ echo '<span class="badge bg-success">Paid</span>';}else{echo '<span class="badge bg-danger">Failed</span>';} ?></td>
                                       <td><?php echo $value->teacher_state ?></td>
                                    </tr>
                                    <?php } ?>
                                 </tbody>
                              </table>
