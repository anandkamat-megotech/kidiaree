...
if(isset($_POST["submit"]))
{
	...
	if($error == '')
	{
		...
		$mail->AddAddress($_POST["email"]);				//Sets the From name of the message
		$mail->setFrom('katerupali92@gmail.com');
				...
				<div class="col-md-8" style="margin:0 auto; float:none;">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" name="name" placeholder="Enter Name" class="form-control" value="Anand" />
						</div>
						<div class="form-group">
							<label>Enter Email</label>
							<input type="text" name="email" class="form-control" placeholder="Enter Email" value="kamatanand9@gmail.com" />
						</div>
						<div class="form-group">
							<label>Enter Subject</label>
							<input type="text" name="subject" class="form-control" placeholder="Enter Subject" value="new email integration" />
						</div>
						<div class="form-group">
