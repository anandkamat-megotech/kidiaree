                     ...
                     <div class="hero-content">
                        ...
                        <div class="text-center logged_in">
                           <select class="" name="activity">
                              ...
                              <option><?php echo $value->kid_name ?>, <?php echo $year; ?> years</option>
                              <?php } ?>
                           </select>
                        </div>
                        <div class="logged_in header-search mt-3">
                     ...
                     <div class="row">
                        <!-- start one category -->
                           <div class="heading-category">
                              <div class="name d-inline-block">Academic Classes</div>
                           ...
                           <div class="testimonial-wrap-02">
                              <div class="testimonial-content-wrap-02">
                                 <div id="owl-demo1" class="owl-carousel owl-theme">
                                    <!-- <div class="swiper-wrapper"> -->
                                    <?php
                                       $getClass1 = $db->query("SELECT * FROM products where status= 3  order by id desc");
                                    ...
                                    <div class="single-course new-width item">
                                       <div class="courses-image">
                                          <a href="<?php echo $row1['product_url'] ;?>?id=<?php echo $row1['id'] ;?>"><img src="<?php echo $row1['thumbnail'] ;?>" alt="Courses"></a>
                                       </div>
                                       <div class="courses-content">
                                          <div class="top-meta">
                                             <div class="tag-time">
                                                <a class="tag" href="<?php echo $row1['product_url'] ;?>"><?php echo $row1['type'] ;?></a>
                                                <p class="time"><i class="fa fa-birthday-cake"></i> <?php echo $row1['age'] ;?> Yrs</p>
                                             </div>
                                          </div>
                                          <h3 class="title mt-2"><a href="<?php echo $row1['product_url'] ;?>?id=<?php echo $row1['id'] ;?>"><?php echo $row1['name'] ;?></a></h3>
                                          <div class="top-meta  mt-2">
                                             <span class="price">
                                             <span class="sale-price">INR <?php echo $row1['price'] ;?></span>
                                             </span>
                                          </div>
                                       </div>
                                    </div>
