...
<head>
    ...
    <title>kidiaree - Largest selection of classes and activities for kids</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="Largest selection of classes and activities for kids">
    ...
    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="assets/css/plugins/all.min.css?v=0.09">
    <link rel="stylesheet" href="assets/css/plugins/flaticon.css?v=0.09">

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="assets/css/plugins/bootstrap.min.css?v=0.09">
    <link rel="stylesheet" href="assets/css/plugins/swiper-bundle.min.css?v=0.09">
    <link rel="stylesheet" href="assets/css/plugins/aos.css?v=0.09">
    <link rel="stylesheet" href="assets/css/plugins/nice-select.css?v=0.09">
    <link rel="stylesheet" href="assets/css/plugins/jquery.powertip.min.css?v=0.09">
    <link rel="stylesheet" href="assets/css/plugins/magnific-popup.css?v=0.09">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="assets/css/style.css?v=0.09">
    <link rel="stylesheet" href="assets/css/kidiaree.css?v=0.09">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="section header">
                ...
                <div class="container">
                    <div class="header-top-wrap">
                        <div class="header-top-content text-center">
                            <p>Largest selection of classes and activities for kids <span>Kidiaree</span></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="header-bottom-section">
                ...
                <div class="horizontal-header clearfix d-lg-none"> <div class="container"> <a id="horizontal-navtoggle" class="animated-arrow"><span><div class="header-toggle d-lg-none">
                            ...
                            </div></span></a> <span class="smllogo d-lg-none"><img src="assets/images/logo.png" width="120" alt="img"></span><a  class="callusbtn d-lg-none" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenu"><i class="flaticon-user-2" aria-hidden="true"></i></a> </div> </div>
        ...
        <div class="offcanvas offcanvas-end" id="offcanvasMenu">
            ...
            <div class="offcanvas-body">
                <div class="offcanvas-menu">
                    <ul class="main-menu">
                        <li><a href="#"><b class="color1-k ">Kid</b> details  </a></li>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="sidebar-wrap-02">
                                ...
                                <div class="sidebar-widget-02">
                                    <h3 class="widget-title">Type of Events</h3>
                                    ...
                                    <div class="widget-checkbox">
                                        <ul class="checkbox-list">
                                            ...
                                            <li class="form-check">
                                                ...
                                                <label class="form-check-label" for="checkbox2">Offline (09)</label>
                                            </li>
                                            <li class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="checkbox2">
                                                <label class="form-check-label" for="checkbox2">Daily (05)</label>
                                            </li>
                                            <li class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="checkbox2">
                                                <label class="form-check-label" for="checkbox2">Weekly (03)</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget-checkbox">
                                        <ul class="checkbox-list">
                                            <li class="form-check">
                                                ...
                                                <label class="form-check-label" for="checkbox3">2-5 (11)</label>
                                            </li>
                                            <li class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="checkbox4">
                                                <label class="form-check-label" for="checkbox4">6-9 (07)</label>
                                            </li>
                                            <li class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="checkbox5">
                                                <label class="form-check-label" for="checkbox5">10-12 (11)</label>
                                            </li>
                                            <li class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="checkbox5">
                                                <label class="form-check-label" for="checkbox5">13-16 (09)</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="course-top-bar">
                                <div class="course-top-text">
                                    <p>We found <span>78</span> events For You</p>
                                </div>
                                                ...
                                                <div class="widget-checkbox">
                                                    <ul class="checkbox-list">
                                                        <li class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="checkbox14">Day (11)</label>
                                                        </li>
                                                        <li class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox15">
                                                            <label class="form-check-label" for="checkbox15">Date (09)</label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            ...
                                            <div class="single-course">
                                                ...
                                                <div class="courses-content">
                                                    <div class="top-meta">
                                                        <div class="tag-time">
                                                            <a class="tag" href="#">Age 2-5</a>
                                                            <p class="time"><i class="far fa-clock"></i> Weekly</p>
                                                        </div>
                                                        <span class="price">
                                                        <span class="sale-price">Online</span>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            ...
                                            <div class="single-course">
                                                ...
                                                <div class="courses-content">
                                                    <div class="top-meta">
                                                        <div class="tag-time">
                                                            <a class="tag" href="#">Age 6-9</a>
                                                            <p class="time"><i class="far fa-clock"></i> Daily</p>
                                                        </div>
                                                        <span class="price">
                                                        <span class="sale-price">Offline</span>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            ...
                                            <div class="single-course">
                                                ...
                                                <div class="courses-content">
                                                    <div class="top-meta">
                                                        <div class="tag-time">
                                                            <a class="tag" href="#">Age 10-12</a>
                                                            <p class="time"><i class="far fa-clock"></i> Weekends</p>
                                                        </div>
                                                        <span class="price">
                                                        <span class="sale-price">Offline</span>
                                                        </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="footer-widget widget-about">
                                ...
                                <p class="text">World largest online learning platform.</p>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="copyright-text">
                                    <p>© Copyright 2023 kidiaree. All rights reserved. </p>
                                </div>
        ...
        <div id="course-hover1">
            <div class="course-hover">
                ...
                <div class="courses-btn"><a class="btn" href="course-details.html">Event Full Details</a></div>
            </div>
        </div>
        <!-- course hover End -->
    ...
    <!-- Main JS -->
    <script src="assets/js/main.js?v=0.09"></script>
