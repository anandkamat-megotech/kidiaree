                    ...
                    <div class="row">
                        <div class="col-lg-6 mx-auto">
                             ...
                             <div class="login-register-box">
                                ...
                                <div class="login-register-form text-center">
                                    <h4 class="text-success">Thank you for joining Kidiaree!</h4>
                                    <p>Your details will be reviewed and upon successful completion, you will receive the ‘Terms & Conditions’ for your acceptance, on your email ID registered with us</p>
