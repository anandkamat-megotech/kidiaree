...
<head>
    ...
    <link rel="stylesheet" href="assets/css/kidiaree.css">
...
<body>
    ...
    <div class="main-wrapper">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="hero-content">
                            ...
                            <div class="hero-btn" data-aos="fade-up" data-aos-delay="900">
                                <a class="btn" href="login-register.html">Let us find you the right activities</a>
                            </div>
                        </div>
                        <!-- Hero Content End -->
                    </div>
        ...
        <!-- Category Start -->
        <div class="section kidiaree-category-section">
            <div class="container">
        ...
        <!-- Offer Start -->
        <div class="section kidiaree-offer-section section-padding-03">
            <div class="container">
                <!-- Offer Wrap Start -->
        ...
        <!-- Counter Start -->
        <div class="section kidiaree-counter-section section-padding-02" style="background-image: url(assets/images/bg/counter-bg.png);">
            <div class="shape-1">
        ...
        <!-- Brand Start -->
        <div class="section kidiaree-brand-section section-padding">
            <div class="container">
                        ...
                        <div class="col-lg-6">
                            <div class="brand-content-wrap">
                                <div class="row g-0">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="kidiaree-brand-box brand-box-03">
                                            <!-- Single Brand Start -->
                                            <div class="single-brand">
        ...
        <!-- Testimonial Start -->
        <div class="section kidiaree-testimonial-section">
            <div class="container">
        ...
        <!-- Blog Start -->
        <div class="section kidiaree-blog-section section-padding">
            <div class="container">
        ...
        <div class="section kidiaree-cta-section section-padding-03" style="background-image: url(assets/images/bg/cta-bg.jpg);">
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="footer-widget widget-about">
                                ...
                                <p class="text">Curated Classes & Activities for Children Download our apps to start learning.</p>
