...
<head>
    ...
    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="assets/css/plugins/all.min.css??v=0.07">
    <link rel="stylesheet" href="assets/css/plugins/flaticon.css??v=0.07">

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="assets/css/plugins/bootstrap.min.css??v=0.07">
    <link rel="stylesheet" href="assets/css/plugins/swiper-bundle.min.css??v=0.07">
    <link rel="stylesheet" href="assets/css/plugins/aos.css??v=0.07">
    <link rel="stylesheet" href="assets/css/plugins/nice-select.css??v=0.07">
    <link rel="stylesheet" href="assets/css/plugins/jquery.powertip.min.css??v=0.07">
    <link rel="stylesheet" href="assets/css/plugins/magnific-popup.css??v=0.07">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="assets/css/style.css??v=0.07">
    <link rel="stylesheet" href="assets/css/kidiaree.css??v=0.07">
...
<body>
                            ...
                            <div class="header-cart dropdown  d-none">
                                ...
                                <div class="dropdown-menu dropdown-cart">
                                    ...
                                    <div class="cart-items">
                                        ...
                                        <div class="single-cart-item">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <span class="quantity"> 2 x ₹5900.99 </span>
                                            </div>
                                    ...
                                    <div class="cart-total">
                                        ...
                                        <span class="value">₹20900.95</span>
                                    </div>
                                    <!-- Cart Total End -->
                            ...
                            <div class="sidebar-details-video-description">
                                ...
                                <div class="sidebar-description">
                                    <div class="price-wrap">
                                        ...
                                        <div class="price">
                                            <span class="sale-price">₹4900.99</span>
                                            <span class="regular-price">₹7020</span>
                                        </div>
                                    </div>
    ...
    <!-- Main JS -->
    <script src="assets/js/main.js??v=0.07"></script>
