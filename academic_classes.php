                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="page-banner text-center">
                                <h2 class="title">Academic Classes</h2>
                                <ul class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Academic Classes</li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="course-top-bar">
                                <div class="course-top-text">
                                    <p>We found <span>20</span> Classes For You</p>
                                </div>
                                            ...
                                            <div class="swiper-container testimonial-02-active">
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="single-testimonial-02 d-flex justify-content-center flex-wrap">
                                                            <!-- Single Courses Start -->
                                                                <div class="single-course new-width">
                                                                    <div class="courses-image">
                                                                        <a href="single-session.php"><img src="assets/images/zenny-new.png" alt="Courses"></a>
                                                                    </div>
                                                                    <div class="courses-content">
                                                                        ...
                                                                        <h3 class="title mt-2"><a href="single-session.php">Creative Writing Lab</a></h3>
                                                            ...
                                                            <div class="single-course new-width">
                                                                    ...
                                                                    <div class="courses-content">
                                                                        ...
                                                                        <h3 class="title mt-2"><a href="course-details.html">Drums for Beginners</a></h3>
                                                                        <div class="top-meta mt-2">
                                                                            <span class="price">
