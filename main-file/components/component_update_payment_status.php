...
function response_ok($id, $timestamp){
    ...
    $str = '{"code": 200, "timestamp": '.$timestamp.', "id": "'.$id.'"}';
    return $str;
}
...
function response_payment_not_verified($timestamp){
    http_response_code(403);
    $str = '{"code": 403, "timestamp": '.$timestamp.', "message": "'.ERR_PAYMENT_NOT_VERIFIED.'"}';
    return $str;
}
