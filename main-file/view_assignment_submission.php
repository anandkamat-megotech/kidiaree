...
//Get studentAttachmentUrl of from AssignmentSubmissionsMapping
$studentAttachmentUrl = getSingleValue($db, "SELECT studentAttachmentUrl FROM AssignmentSubmissionsMapping WHERE id = ?", [$idAssignmentSubmission]);

$format = substr( $studentAttachmentUrl, -3 );
...
$pdf = (file_get_contents($studentAttachmentUrl));
echo $pdf;
