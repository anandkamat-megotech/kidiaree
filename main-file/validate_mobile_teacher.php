...
include './services/service_create_teacher.php';
...
$serviceCreateTeacher = new ServiceCreateTeacher();
...
if ($rowCountMobileExist == 0) {
    $serviceCreateTeacher->serve($db, "mobile", $mobile);
    $mailSubject = "New Teacher Registered";
