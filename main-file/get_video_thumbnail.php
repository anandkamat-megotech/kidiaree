...
include './components/component_get_video_thumbnail.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_kpoint_get_video_thumbnail.php';
...
$serviceKPointGetVideoThumbnail = new ServiceKPointGetVideoThumbnail();
...
$image = $serviceKPointGetVideoThumbnail->serve($displayname, $email, $idVideo);
