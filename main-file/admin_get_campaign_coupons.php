...
include './components/component_admin_get_campaign_coupons.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_admin_get_campaign_coupons.php';
...
$serviceAdminGetCampaignCoupons = new ServiceAdminGetCampaignCoupons();
...
$json = $serviceAdminGetCampaignCoupons->serve($db, $id);
