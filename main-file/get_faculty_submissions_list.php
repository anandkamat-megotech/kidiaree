...
include './components/component_get_faculty_submissions_list.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_get_faculty_submissions_list.php';
include './services/service_get_admin_submissions_list.php';
...
$serviceGetFacultySubmissionsList = new ServiceGetFacultySubmissionsList();
$serviceGetAdminSubmissionsList = new ServiceGetAdminSubmissionsList();
...
if ($idRole == $idFacultyMaster) {
    ...
    $json = $serviceGetFacultySubmissionsList->serve($db, $idFaculty, $offset);

    echo response_ok($json, time());
}else{
    $json = $serviceGetAdminSubmissionsList->serve($db, $offset);
