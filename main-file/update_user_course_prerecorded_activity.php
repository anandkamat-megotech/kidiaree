...
//Get idPrerecordedSession from SchedulesMaster
$idPrerecordedSession = getSingleValue($db, "SELECT idPrerecordedSession FROM SchedulesMaster WHERE id = ?", [$idSchedule]);
