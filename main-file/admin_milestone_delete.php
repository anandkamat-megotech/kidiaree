...
include './components/component_admin_milestone_delete.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_admin_milestone_delete.php';
...
$serviceAdminMilestoneDelete = new ServiceAdminMilestoneDelete();
...
$json = $serviceAdminMilestoneDelete->serve($db, $id);
