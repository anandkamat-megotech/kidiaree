...
include './components/component_get_course_details.php';
include './services/service_base.php';
include './services/service_get_course_details.php';
...
$serviceGetCourseDetails = new ServiceGetCourseDetails();
...
$json = $serviceGetCourseDetails->serve($db, $idCourse);
