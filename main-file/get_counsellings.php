...
include './components/component_get_counsellings.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_faculty_get_counsellings.php';
include './services/service_admin_get_counsellings.php';
...
$serviceFacultyGetCounsellings = new ServiceFacultyGetCounsellings();
$serviceAdminGetCounsellings = new ServiceAdminGetCounsellings();
...
if ($idRole == $idFacultyMaster) {
    ...
    $json = $serviceFacultyGetCounsellings->serve($db, $idFaculty, $offset);

    echo response_ok($json, time());
}else{
    $json = $serviceAdminGetCounsellings->serve($db, $offset);
