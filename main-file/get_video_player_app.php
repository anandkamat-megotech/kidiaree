...
include './services/service_kpoint_get_video_player_app.php';
...
$serviceKPointGetVideoPlayerApp = new ServiceKPointGetVideoPlayerApp();
...
$html = $serviceKPointGetVideoPlayerApp->serve($displayname, $email, $idVideo, $offset);
