...
include './components/component_get_subject_details.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_get_subject_details.php';
...
$serviceGetSubjectDetails = new ServiceGetSubjectDetails();
...
$json = $serviceGetSubjectDetails->serve($db, $id);
