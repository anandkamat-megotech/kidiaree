...
include './components/component_admin_move_milestone_up.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_admin_move_milestone_up.php';
...
$serviceAdminMoveMilestoneUp = new ServiceAdminMoveMilestoneUp();
...
if($idMilestonePrevious == ''){
    echo response_ok($id, time());
    return;
}


$serviceAdminMoveMilestoneUp->serve($db, $id, $milestoneSequenceNumber, $idCourse);
