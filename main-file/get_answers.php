...
include './services/service_faculty_get_answers.php';
include './services/service_admin_get_answers.php';
...
$serviceFacultyGetAnswers = new ServiceFacultyGetAnswers();
$serviceAdminGetAnswers = new ServiceAdminGetAnswers();
...
if ($idRole == $idFacultyMaster) {
    ...
    $json = $serviceFacultyGetAnswers->serve($db, $idFaculty, $offset);

    echo response_ok($json, time());
}else{
    $json = $serviceAdminGetAnswers->serve($db, $offset);
