...
include './components/component_blacklist_answer.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_un_blacklist_answer.php';
...
$serviceUnBlacklistAnswer = new ServiceUnBlacklistAnswer();
...
$json = $serviceUnBlacklistAnswer->serve($db, $idAnswer);
