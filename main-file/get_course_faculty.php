...
include './components/component_get_course_faculty.php';
include './services/service_base.php';
include './services/service_get_course_faculty.php';
...
$serviceGetCourseFaculty = new ServiceGetCourseFaculty();
...
$json = $serviceGetCourseFaculty->serve($db, $idCourse);
