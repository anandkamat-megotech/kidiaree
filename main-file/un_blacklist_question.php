...
include './services/service_un_blacklist_question.php';
...
$serviceUnBlacklistQuestion = new ServiceUnBlacklistQuestion();
...
$json = $serviceUnBlacklistQuestion->serve($db, $idQuestion);
