...
include './components/component_get_user_course_activity.php';
include './services/service_base.php';
include './services/service_check_token_validity.php';
include './services/service_get_user_course_activity.php';
...
$serviceGetUserCourseActivity = new ServiceGetUserCourseActivity();
...
$json = $serviceGetUserCourseActivity->serve($db, $idCourse, $idUser);
