...
<head>
    ...
    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="assets/css/plugins/all.min.css?v=0.29">
    <link rel="stylesheet" href="assets/css/plugins/flaticon.css?v=0.29">

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="assets/css/plugins/bootstrap.min.css?v=0.29">
    <link rel="stylesheet" href="assets/css/plugins/swiper-bundle.min.css?v=0.29">
    <link rel="stylesheet" href="assets/css/plugins/aos.css?v=0.29">
    <link rel="stylesheet" href="assets/css/plugins/nice-select.css?v=0.29">
    <link rel="stylesheet" href="assets/css/plugins/jquery.powertip.min.css?v=0.29">
    <link rel="stylesheet" href="assets/css/plugins/magnific-popup.css?v=0.29">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="assets/css/style.css?v=0.29">
    <link rel="stylesheet" href="assets/css/kidiaree.css?v=0.27">
                            ...
                            <div class="sidebar-details-video-description">
                                ...
                                <div class="sidebar-description">
                                    <div class="price-wrap">
                                        ...
                                        <div class="price">
                                            <span class="sale-price">INR 5k</span>
                                            <span class="regular-price">INR 10200</span>
                                        </div>
                                    </div>
                                    <ul class="description-list">
                                        <li><i class="flaticon-location-pin"></i> Location <span>Online</span></li>
                                        <li><i class="fas fa-birthday-cake"></i> Age <span>2-5</span></li>
                                        <li><i class="far fa-file-alt"></i> Session <span>Single Session</span></li>
