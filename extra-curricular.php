                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="sidebar-wrap-02">
                                ...
                                <div class="sidebar-widget-02">
                                    <h3 class="widget-title">Search Activity</h3>

                                    <div class="header-search">
                                        <form>
                                            <!-- <li class="form-check"> -->
                                            <input class="form-control mt-2" type="text" placeholder="e.g. Creative writing or gymnastics or guitar" value="" id="checkbox1">
                                                    ...
                                                    <div class="widget-checkbox">
                                                        <ul class="checkbox-list">
                                                            <li class="form-check">
                                                                ...
                                                                <label class="form-check-label" for="checkbox3">Art</label>
                                                                <ul class="checkbox-list">
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Doodle</label>
                                                                        </li>
                                                                </ul>
                                                            </li>
                                                            <li class="form-check">
                                                                <input class="form-check-input" type="checkbox" value="" id="checkbox4">
                                                                <label class="form-check-label" for="checkbox4">Creative Writing</label>
                                                            </li>
                                                            <li class="form-check">
                                                                <input class="form-check-input" type="checkbox" value="" id="checkbox5">
                                                                <label class="form-check-label" for="checkbox5">Dance</label>
                                                                <ul class="checkbox-list">
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Indian</label>
                                                                            <ul class="checkbox-list">
                                                                                <li class="form-check">
                                                                                    <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                                    <label class="form-check-label" for="checkbox12">Bharatnatyam</label>
                                                                                </li>
                                                                                <li class="form-check">
                                                                                    <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                                    <label class="form-check-label" for="checkbox12">Odissi</label>
                                                                                </li>
                                                                                <li class="form-check">
                                                                                    <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                                    <label class="form-check-label" for="checkbox12">Kathak</label>
                                                                                </li>
                                                                            </ul>
                                                                        </li>
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox4">
                                                                            <label class="form-check-label" for="checkbox4">Fusion</label>
                                                                        </li>
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox4">
                                                                            <label class="form-check-label" for="checkbox4">Western</label>
                                                                        </li>
                                                                </ul>
                                                            </li>
                                                            <li class="form-check">
                                                                <input class="form-check-input" type="checkbox" value="" id="checkbox6">
                                                                <label class="form-check-label" for="checkbox7">Music </label>
                                                                <li class="form-check">
                                                                    <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                    <label class="form-check-label" for="checkbox12">Instruments</label>
                                                                    <ul class="checkbox-list">
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Clapbox</label>
                                                                        </li>
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Drums</label>
                                                                        </li>
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Guitar</label>
                                                                        </li>
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Keyboard</label>
                                                                        </li>
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Piano</label>
                                                                        </li>
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Tabla</label>
                                                                        </li>
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Ukulele</label>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                <li class="form-check">
                                                                    <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                    <label class="form-check-label" for="checkbox12">Vocals & Singing</label>
                                                                    <ul class="checkbox-list">
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Indian</label>
                                                                        ...
                                                                        <li class="form-check">
                                                                            <input class="form-check-input" type="checkbox" value="" id="checkbox12">
                                                                            <label class="form-check-label" for="checkbox12">Western</label>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                            </li>
                                                            <li class="form-check">
                                                                ...
                                                                <label class="form-check-label" for="checkbox8">Speech & Drama</label>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="course-top-bar">
                                <div class="course-top-text">
                                    <p>We found <span>28</span> Activities For You</p>
                                </div>
                            ...
                            <div class="collapse" id="collapseFilters">
                                <div class="course-collapse">
                                    <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <!-- Sidebar Wrapper Start -->
                                                <div class="sidebar-widget-02 mt-4">
                                ...
                                <div class="tab-pane fade show active" id="grid">
                                                            ...
                                                            <!-- Single Courses Start -->
                                                                <div class="single-course">
                                                                    <div class="courses-image">
                                                                        <a href="single-session.php"><img src="assets/images/TMG Drums.png" alt="Courses"></a>
                                                                    </div>
                                                                    <div class="courses-content">
                                                                        <div class="top-meta">
                                                                            ...
                                                                            <span class="price">
                                                                            <span class="sale-price">INR 8000/Session</span>
                                                                            </span>
                                                                        </div>
                                                                        <h3 class="title"><a href="single-session.php">Drums for Beginners</a></h3>
                                                                        <div class="courses-meta">
                                                                            <p class="author-name"><span>By</span> The Musical Gurukul</p>
                                                                            <div class="rating">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-6">
                                            ...
                                            <div class="single-course">
                                                <div class="courses-image">
                                                    <a href="single-session.php"><img src="assets/images/courses/courses-1.jpg" alt="Courses"></a>
                                                </div>
                                                <div class="courses-content">
                                                    <div class="top-meta">
                                                        <div class="tag-time">
                                                    ...
                                                    <h3 class="title"><a href="single-session.php">Getting Started with the Linux Command Line</a></h3>
                                                    <div class="courses-meta">
                                                        <p class="author-name"><span>By</span> Andrew paker</p>
                                                        <div class="rating">
                                                            <div class="rating-star">
                                            ...
                                            <div class="single-course">
                                                ...
                                                <div class="courses-content">
                                                    <div class="top-meta">
                                                        <div class="tag-time">
                                                            <a class="tag" href="#">Offline</a>
                                                            <p class="time"><i class="far fa-clock"></i> Regular</p>
                                                        </div>
                                                        <span class="price">
                                                        <span class="sale-price">INR 10K/Month</span>
                                                        </span>
                                                    </div>
