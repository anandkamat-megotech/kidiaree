...
$sql = "INSERT INTO enuiary_details (`type`,`f_name`, `org_name`, `email`, `mobile_number`, `addressLine1`, `addressLine2`, `area`, `city`, `state`, `country`, `pincode`, `pan`, `GSTIN`, `bname`, `account_name`, `bank_name`, `account_number`, `ifsc_code`, `panDoc`, `addDoc`, `status`, `designation`)
VALUES ('ORG','".$_POST['f_name']."', '".$_POST['org_name']."', '".$_POST['email']."', '".$_POST['mobile_number']."', '".$_POST['addressLine1']."', '".$_POST['addressLine2']."', '".$_POST['area']."', '".$_POST['city']."', '".$_POST['state']."', '".$_POST['country']."','".$_POST['pincode']."','".$_POST['pan']."','".$_POST['GSTIN']."','".$_POST['bname']."','".$_POST['account_name']."','".$_POST['bank_name']."','".$_POST['account_number']."','".$_POST['ifsc_code']."','".$pan_url."','".$add_url."','0','".$_POST['designation']."')";
// die;
$db->query($sql);
                             ...
                             <div class="login-register-box">
                                ...
                                <div class="login-register-form">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="single-form">
                                            <input type="text" class="form-control" id="addressLine1" name="addressLine1" placeholder="Org Address Line 1 ">
                                        </div>
                                        <div class="single-form">
                                            <input type="text" class="form-control" id="addressLine2" name="addressLine2" placeholder="Org Address Line 2">
                                        </div>
                                        <div class="single-form">
